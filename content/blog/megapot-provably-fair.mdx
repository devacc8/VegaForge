...
I pulled the source of the deployed MegaPot contract and replayed draw 178 myself. Settlement landed in block 51480730, transaction `0xd6274c...328df`, and the seed sits in the `EntropyFulfilled` event: `0x94473962f0534e137e168d06c56a72e52a72706a41df91e6fcd12d7a1cd52b63`.

I ran that seed through `keccak256` and `FisherYatesRejection.draw` in my own script and got exactly what the chain recorded: 11, 21, 13, 6, 4 plus bonusball 3. The draw is fair in the sense that the result is determined by the published seed and by nothing else.
...
MegaPot's geoblock covers most of the world. The published list of prohibited jurisdictions runs to more than thirty countries:
