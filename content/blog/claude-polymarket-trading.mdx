...
I'm currently building my own version of this: a prediction agent that combines [weather API data](/blog/weather-bots-polymarket) with LLM-powered forecasting, starting with paper trading and scaling into live bets. The ilovecircle approach (Claude as coding partner, not standalone oracle) is exactly the playbook I'm following. I'll be documenting the entire process on this blog: the architecture, the prompt iterations, and the real numbers.
...
**If you want to build an agent like this,** I have spent the last year on Polymarket-related projects and I am glad to share what worked and what did not, including the parts I would skip next time. DM me on [X](https://x.com/vvegalex) and tell me what you are building.
