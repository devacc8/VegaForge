...
So yes. Part of the harness will melt away as models grow. But determinism, state, and project context will stay. This isn't a crutch for a weak model. It's simply [how reliable systems get built](/blog/agent-failures-not-about-model).
...
**P.S.** If you are building a harness and want a second opinion on it, that is the work I do: deterministic CLI tools, curated context, state, and guardrails around a model everyone rents from the same API. DM me on [X](https://x.com/vvegalex) and tell me what you are building.
