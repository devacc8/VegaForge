...
**P.S.** If your model bill is outgrowing the product, I have been doing this routing work myself: what each request actually needs, which model gets it, and what happens when the cheap one fails. If you want the same look at your costs, DM me on [X](https://x.com/vvegalex) and tell me what you are running.
