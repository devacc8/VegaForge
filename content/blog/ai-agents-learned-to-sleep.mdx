...
The shift happened fast. A year ago, agent memory was an academic concept. Today it's [production infrastructure](/blog/harness-is-the-moat).
...
**P.S.** If you are designing memory for an agent, I have been building exactly this: what gets stored, what gets scored, what gets forgotten on purpose. If you want a second opinion on your scheme, DM me on [X](https://x.com/vvegalex) and tell me what your agent remembers.
