...
Both reveal a gap between how agents are marketed and how they actually behave. The marketing says "magical productivity booster." The reality says "deterministic system with [complex, non-obvious failure modes](/blog/agent-failures-not-about-model)."
...
**P.S.** If you are giving an agent access to anything that matters, I have been building the guardrails: what it may touch, what it has to ask about first, and what happens when it does neither. If you want yours reviewed before it does damage, DM me on [X](https://x.com/vvegalex) and tell me what your agent can reach.
