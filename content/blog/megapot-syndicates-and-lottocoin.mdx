...
There is a coin on Base called [LottoCoin](https://www.lottocoin.fun/) that buys lottery tickets instead of you. \$LOTTO takes the fees from its own trades, sends them to MegaPot, calls itself a referrer and buys back its own token with the winnings. In round 173 it took a jackpot of \$236,685.73.
