...
The benchmark measures capability. [Production measures reliability](/blog/claude-i-stopped-understanding). These are different things.
...
Consider a developer reviewing AI-generated code. A year ago, AI wrote obviously broken code, and you caught every mistake. Six months ago, AI wrote mostly correct code, and you caught most mistakes. Now AI writes code that's correct more often than you'd catch errors if you reviewed it casually. What's the value of reviewing code you're not good enough to audit?
...
**P.S.** If the model is good enough for your use case and the agent still fails, the difference is the harness: deterministic tools, curated context, guardrails for something that runs unattended. I have been building those for my own products. If the harness is what is missing, DM me on [X](https://x.com/vvegalex) and tell me what you are building.
