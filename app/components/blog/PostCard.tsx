...
export function PostCard({ post }: { post: PostMeta }) {
  ...
  return (
    <a href={`/blog/${post.slug}`} className="group block" aria-label={`Read: ${post.title}`}>
      <article className="relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-6 md:p-8 transition-all duration-500 shadow-xs dark:shadow-none">
