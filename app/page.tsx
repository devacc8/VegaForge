        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 group relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-8 md:p-12 transition-all duration-500 shadow-xs dark:shadow-none">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 py-6 border-y border-neutral-200 dark:border-neutral-800">
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">95%</p>
                  <p className="text-xs text-neutral-500">To Winner</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-forge-600 dark:text-forge-500">2s</p>
                  <p className="text-xs text-neutral-500">Passkey Login</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">3</p>
                  <p className="text-xs text-neutral-500">Games Live</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">0</p>
                  <p className="text-xs text-neutral-500">SOL Needed</p>
                </div>
              </div>

              {/* Tech stack */}
              <div className="flex flex-wrap gap-2">
                {['Solana', 'Anchor', 'Rust', 'Next.js 15', 'tRPC', 'Privy'].map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700/50 rounded-full text-xs text-neutral-600 dark:text-neutral-400"
                  >
          ...
          <div className="mt-8 group relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-8 md:p-12 transition-all duration-500 shadow-xs dark:shadow-none">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                <div>
                  <p className="font-mono text-xs text-forge-600 dark:text-forge-500 mb-2">2026 · CHROME EXTENSION</p>
                  <h3 className="font-display font-bold text-2xl md:text-3xl text-neutral-900 dark:text-white">
                    Curfew
                  </h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  <a
                    href="https://chromewebstore.google.com/detail/curfew/obnikdokealeimpbhfbjhpdmfcgbgcje"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://github.com/devacc8/curfew-extension"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 border border-neutral-300 dark:border-forge-600/50 hover:border-forge-500 dark:hover:border-forge-500 rounded-full text-sm text-neutral-700 dark:text-forge-400 hover:text-forge-600 dark:hover:text-forge-300 hover:bg-forge-500/5 dark:hover:bg-forge-500/10 transition-all"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 py-6 border-y border-neutral-200 dark:border-neutral-800">
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">0</p>
                  <p className="text-xs text-neutral-500">Network Requests</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-forge-600 dark:text-forge-500">Per-site</p>
                  <p className="text-xs text-neutral-500">Permissions</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">200</p>
                  <p className="text-xs text-neutral-500">Unit Tests</p>
                </div>
                <div>
              ...
              {/* Tech stack */}
              <div className="flex flex-wrap gap-2">
                {['TypeScript', 'Manifest V3', 'Chrome APIs', 'Declarative Net Request', 'No Tracking'].map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700/50 rounded-full text-xs text-neutral-600 dark:text-neutral-400"
                  >
          ...
          <div className="mt-8 group relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-8 md:p-12 transition-all duration-500 shadow-xs dark:shadow-none">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <a
                    href="https://chromewebstore.google.com/detail/coinpeek-bitcoin-price-ba/konlmcdlofpoegdkbjocdfojejmfkfbo"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-forge-600 hover:bg-forge-500 text-white rounded-full text-sm font-medium transition-all"
                  >
          ...
          <div className="mt-8 group relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-8 md:p-12 transition-all duration-500 shadow-xs dark:shadow-none">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <a
                    href="https://avaxlens.vercel.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 border border-neutral-300 dark:border-forge-600/50 hover:border-forge-500 dark:hover:border-forge-500 rounded-full text-sm text-neutral-700 dark:text-forge-400 hover:text-forge-600 dark:hover:text-forge-300 hover:bg-forge-500/5 dark:hover:bg-forge-500/10 transition-all"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 py-6 border-y border-neutral-200 dark:border-neutral-800">
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">$0</p>
                  <p className="text-xs text-neutral-500">Free Forever</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-forge-600 dark:text-forge-500">10s</p>
                  <p className="text-xs text-neutral-500">Time to Insights</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">ABI</p>
                  <p className="text-xs text-neutral-500">Auto Decoding</p>
                </div>
                <div>
                  <p className="font-display font-bold text-2xl text-neutral-900 dark:text-white">0</p>
                  <p className="text-xs text-neutral-500">Setup Required</p>
                </div>
              </div>

              {/* Tech stack */}
              <div className="flex flex-wrap gap-2">
                {['Next.js 16', 'TypeScript', 'Tailwind CSS', 'Recharts', 'viem', 'Avalanche'].map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700/50 rounded-full text-xs text-neutral-600 dark:text-neutral-400"
                  >
          ...
          {/* Project Card: Open Source Contributions */}
          <div className="mt-8 group relative bg-white dark:bg-linear-to-br dark:from-neutral-900/80 dark:to-neutral-950/80 border border-neutral-200 dark:border-neutral-800 hover:border-forge-500/50 dark:hover:border-forge-600/50 rounded-2xl p-8 md:p-12 transition-all duration-500 shadow-xs dark:shadow-none">
            {/* Glow effect on hover */}
            <div className="absolute inset-0 bg-forge-500/5 dark:bg-forge-600/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="relative z-10">
              ...
              {/* Tech stack */}
              <div className="flex flex-wrap gap-2">
                {['Open Source', 'Base', 'Talent Protocol', 'Documentation', 'Unity SDK'].map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700/50 rounded-full text-xs text-neutral-600 dark:text-neutral-400"
                  >
